...
<body>
        ...
        <tr>
            ...
            <td class="invoice-details">
                ...
                <table style="margin-left: auto;">
                    <tr>
                        <td class="text-right text-muted-foreground text-sm" style="padding-right: 15px;">Receipt No:</td>
                        <td class="text-right font-bold">{{ $purchase->receipt_number }}</td>
                    </tr>
                    <tr>
                        <td class="text-right text-muted-foreground text-sm" style="padding-right: 15px;">Purchase Date:</td>
                        <td class="text-right font-bold">{{ $purchase->purchase_date->format('M d, Y') }}</td>
                    </tr>
                    <tr>
                        <td class="text-right text-muted-foreground text-sm" style="padding-right: 15px;">Reference:</td>
    ...
    <div class="footer">
        <div class="footer-content">
            <p class="font-bold mb-1">Payment receipt for fish purchase made to {{ $purchase->supplier->name }}.</p>
            <p>For any questions about this receipt, please contact Zefi on +677 7799978, Honiara, Solomon Islands</p>
