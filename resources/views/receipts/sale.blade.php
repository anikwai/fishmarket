...
<head>
    ...
    <title>Receipt {{ $receipt->receipt_number ?? 'RCP-' . str_pad((string) $sale->id, 6, '0', STR_PAD_LEFT) }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="receipt-wrapper">
            ...
            <table style="width: 100%; border-collapse: collapse; table-layout: fixed;">
                <tr>
                    ...
                    <td class="receipt-section" style="width: 45%; text-align: right; padding-left: 20px; vertical-align: top; color: white;">
                        ...
                        <div class="receipt-number" style="font-size: 28px; font-weight: 700; margin-bottom: 6px; letter-spacing: -0.5px; color: white;">{{ $receipt->receipt_number ?? 'RCP-' . date('Y') . '-' . str_pad((string) $sale->id, 6, '0', STR_PAD_LEFT) }}</div>
        ...
        <div class="content">
            ...
            <div class="footer">
                ...
                <div class="generator">
                    Generated by {{ config('app.name') }} • Receipt {{ $receipt->receipt_number ?? 'RCP-' . str_pad((string) $sale->id, 6, '0', STR_PAD_LEFT) }}
                </div>
            </div>
        </div>
    </div>
