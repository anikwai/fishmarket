    ...
    <div class="invoice-wrapper">
        ...
        <div class="header" style="background-color: #e91e63; color: white; padding: 30px 40px; page-break-inside: avoid;">
            <table style="width: 100%; border-collapse: collapse; table-layout: fixed;">
                <tr>
                    ...
                    <td class="invoice-section" style="width: 45%; text-align: right; padding-left: 20px; vertical-align: top; color: white;">
                        <div class="invoice-label" style="font-size: 12px; text-transform: uppercase; letter-spacing: 1.5px; opacity: 0.9; margin-bottom: 8px; color: white;">Sales Invoice</div>
                        <div class="invoice-number" style="font-size: 28px; font-weight: 700; margin-bottom: 6px; letter-spacing: -0.5px; color: white;">{{ $sale->invoice_number }}</div>
                        <div class="invoice-date" style="font-size: 13px; opacity: 0.9; color: white;">{{ $sale->sale_date->format('F d, Y') }}</div>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="content">
            ...
            <div class="info-section">
                <table>
                    <tr>
                        ...
                        <td>
                            <div class="info-label">Reference Details</div>
                            <div class="info-content muted">
                                <strong>Sale #{{ str_pad((string) $sale->id, 6, '0', STR_PAD_LEFT) }}</strong>
            ...
            <table class="items-table">
                <thead>
                    <tr>
                        ...
                        <th class="text-right" style="width: 18%;">Quantity</th>
            ...
            <div class="footer">
                ...
                <div class="generator">
                    Generated by {{ config('app.name') }} • Invoice {{ $sale->invoice_number }}
                </div>
            </div>
        </div>
    </div>
